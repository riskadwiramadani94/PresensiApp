...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, RefreshControl, ActivityIndicator, Modal, Animated, PanResponder, Platform } from 'react-native';
...
export default function RiwayatPengajuanScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <AppHeader title="Riwayat Pengajuan" showBack={true} />
      ...
      <View style={styles.filterContainer}>
        <TouchableOpacity style={styles.filterButton} onPress={openFilterModal}>
          ...
          <Text style={styles.filterButtonText}>
            {activeTab === 'semua' ? 'Semua Status' : getStatusInfo(activeTab).label}
          </Text>
