  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${getApiUrl(API_CONFIG.ENDPOINTS.LAPORAN)}?${params.toString()}`,
      );
    ...
    <TouchableOpacity
      ...
      onPress={() => {
        ...
        const params = new URLSearchParams({
          ...
          start_date:
            selectedDateFilter === "pilih_tanggal" ? dateRange.start : "",
          end_date: selectedDateFilter === "pilih_tanggal" ? dateRange.end : "",
        });
        router.push(
          `/laporan/detail-dinas/${item.id}?${params.toString()}` as any,
        );
      }}
    >
          ...
          <View
            style={[
              styles.statusBadge,
              {
                backgroundColor:
                  getStatusColor(
                    item.status_dinas || item.status || "pending",
                  ) + "20",
              },
            ]}
          >
                ...
                {[
                  ...
                  >
                    <Ionicons
                      ...
                      size={18}
                      color={
                        selectedDateFilter === option.value ? "#fff" : "#666"
                      }
                    />
                    <Text
                      style={[
